...
class Column {
  ...
  add (segment) {
    ...
    if (this.options.noWrap) {
      ...
      const segmentLength = this.options.widthMode === 'char' ? segment.length : stringWidth$1(segment);
    ...
    if (this.options.pad) {
      const pad = this.options.rtol ? 'padStart' : 'padEnd';
      c = c[pad](this.options.width - (stringWidth$1(c) - c.length));
    }
    this.lines.push(c);
    this.#currentLine = '';
...
export { getColumnOptions, getMergedRows, getWrappedData, tableLayout };
